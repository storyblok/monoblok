...
export const isBridgeLoaded = () =>
  isBrowser() && typeof window.storyblokRegisterEvent !== "undefined";
 ...
 */
export const isVisualEditor = () =>
  isBrowser() && isIframe() && window.location.search.includes("_storyblok");
