import Teaser from "../../playground/vue/src/components/Teaser.vue";
import Grid from "../../playground/vue/src/components/Grid.vue";
import Page from "../../playground/vue/src/components/Page.vue";
...
describe("@storyblok/vue", () => {
  ...
  describe("v-editable directive", () => {
    ...
    it("Don't get data-blok-c and data-blok-uid attributes in production mode", () => {
      cy.get("[data-test=editable-prod]").should("not.have.attr", "data-blok-c");

      cy.get("[data-test=editable-prod]").should("not.have.attr", "data-blok-uid");
    });
  });
  ...
  describe("useStoryblok/StoryblokComponent", () => {
    it("Errors when no using the apiPlugin", () => {
      ...
      cy.get("@error").should("be.calledWithMatch", "You can't use useStoryblok");
    });
  ...
  describe("StoryblokRichText", () => {
    ...
    it("Should render emoji as unicode span correctly", () => {
      ...
      cy.get("span[data-emoji]").should("exist").and("have.attr", "data-emoji");
    });
    ...
    it("Should render links correctly", () => {
      ...
      cy.get("a").should("exist").and("have.attr", "href").and("contain", "storyblok.com");
    });
    ...
    it("should render a custom emoji-randomizer blok component", () => {
      ...
      cy.get("[data-test=emoji-randomizer]").should("exist");
    });
