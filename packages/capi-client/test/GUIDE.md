...
The `@storyblok/playground-capi-schema` package (`packages/capi-client/playground/playground-capi-schema`) covers the full round-trip against a real Storyblok space in `test/specs/capi-round-trip.spec.e2e.ts`:
