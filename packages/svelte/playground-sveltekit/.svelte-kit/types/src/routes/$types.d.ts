...
export type PageData = Expand<
  ...
  > &
    OptionalUnion<
      EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import("./proxy+page.js").load>>>>
    >
>;
...
export type LayoutData = Expand<
  Omit<
    LayoutParentData,
    keyof Kit.LoadProperties<Awaited<ReturnType<typeof import("./proxy+layout.js").load>>>
  > &
    OptionalUnion<
      EnsureDefined<
        Kit.LoadProperties<Awaited<ReturnType<typeof import("./proxy+layout.js").load>>>
      >
    >
>;
