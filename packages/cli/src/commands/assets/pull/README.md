...
- **Private Assets**: If your space contains
  [private assets](https://www.storyblok.com/docs/concepts/assets#private-assets), you must provide
  an `--asset-token` to download them. The asset token can be found in your Storyblok space settings
  under the "Assets" tab. Private assets without a token will result in an error during the pull
  operation.
