...
<p align="center">
  <a href="https://npmjs.com/package/@storyblok/vue">
    <img src="https://img.shields.io/npm/v/@storyblok/vue/latest.svg?style=flat-square&color=8d60ff" alt="Storyblok Vue SDK" />
  </a>
  <a href="https://npmjs.com/package/@storyblok/vue" rel="nofollow">
    <img src="https://img.shields.io/npm/dt/@storyblok/vue.svg?style=appveyor&color=8d60ff" alt="npm">
  </a>
...
- Vue-specific components: `StoryblokComponent` and `StoryblokRichText`
- Vue composables: `useStoryblok` and `useStoryblokRichText`
- Vue directive: `v-editable` for Visual Editor integration
- Vue plugin for easy integration with Vue applications

## Documentation

For complete documentation, please visit
[package reference](https://www.storyblok.com/docs/packages/storyblok-vue)
