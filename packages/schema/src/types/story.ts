...
/**
 * The content fields of a story *without* the `component` discriminant.
 * Use this as the input type when `component` is auto-injected by a helper.
 *
...
export type StoryContent<
  ...
  TSchema extends Component = never,
> = Prettify<
  { component: TComponent['name'] } & StoryContentInput<TComponent, TSchema>
>;
