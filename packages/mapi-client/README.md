...
- **Preventive Rate Limiting**: Token-bucket throttling to avoid hitting API rate limits before they
  occur
...
[package reference](https://www.storyblok.com/docs/libraries/js/management-api-client).
