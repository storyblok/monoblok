...
<h1 align="center">@storyblok/schema</h1>
 <p>
    Shared Storyblok schema types and optional Zod parsers generated from the Management and Content API specifications
  </p>
  <br />
</div>
...
- **Optional Zod Parsers**: Runtime validation via the `@storyblok/schema/zod` subpath when `zod` is installed
