...
@Component({
  ...
  template: `
    @switch (level()) {
      @case (1) {
        <h1><sb-rich-text [sbDocument]="data().content" /></h1>
      }
      @case (2) {
        <h2><sb-rich-text [sbDocument]="data().content" /></h2>
      }
      @case (3) {
        <h3><sb-rich-text [sbDocument]="data().content" /></h3>
      }
      @case (4) {
        <h4><sb-rich-text [sbDocument]="data().content" /></h4>
      }
      @case (5) {
        <h5><sb-rich-text [sbDocument]="data().content" /></h5>
      }
      @case (6) {
        <h6><sb-rich-text [sbDocument]="data().content" /></h6>
      }
    }
  `,
