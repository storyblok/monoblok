...
import type { MeResponses, UpdateMeData, UpdateMeResponses } from "../generated/users/types.gen";
...
export function createUsersResource(deps: Omit<MapiResourceDeps, "spaceId">) {
  ...
  return {
    me<ThrowOnError extends boolean = false>(
      options: {
        signal?: AbortSignal;
        throwOnError?: ThrowOnError;
        fetchOptions?: FetchOptions;
      } = {},
    ): Promise<ApiResponse<MeResponses[200], ThrowOnError>> {
    ...
    updateMe<ThrowOnError extends boolean = false>(options: {
      body: UpdateMeData["body"];
      signal?: AbortSignal;
      throwOnError?: ThrowOnError;
      fetchOptions?: FetchOptions;
    }): Promise<ApiResponse<UpdateMeResponses[200], ThrowOnError>> {
