...
describe("isEditorRequest", () => {
  ...
  describe("space ID validation", () => {
    ...
    it("should handle numeric space IDs as strings", () => {
      const url = new URL(
        "https://example.com/?_storyblok=123&_storyblok_c=456&_storyblok_tk[space_id]=12345",
      );
  ...
  describe("edge cases", () => {
    it("should handle URLs with additional query parameters", () => {
      const url = new URL(
        "https://example.com/?_storyblok=123&_storyblok_c=456&_storyblok_tk[space_id]=789&foo=bar&baz=qux",
      );
      expect(isEditorRequest(url)).toBe(true);
    });
    ...
    it("should handle URLs with hash fragments", () => {
      const url = new URL(
        "https://example.com/?_storyblok=123&_storyblok_c=456&_storyblok_tk[space_id]=789#section",
      );
      expect(isEditorRequest(url)).toBe(true);
    });
    ...
    it("should handle URLs with paths", () => {
      const url = new URL(
        "https://example.com/some/path/?_storyblok=123&_storyblok_c=456&_storyblok_tk[space_id]=789",
      );
      expect(isEditorRequest(url)).toBe(true);
    });
    ...
    it("should work with different protocols", () => {
      const url = new URL(
        "http://example.com/?_storyblok=123&_storyblok_c=456&_storyblok_tk[space_id]=789",
      );
      expect(isEditorRequest(url)).toBe(true);
    });
    ...
    it("should handle localhost URLs", () => {
      const url = new URL(
        "http://localhost:3000/?_storyblok=123&_storyblok_c=456&_storyblok_tk[space_id]=789",
      );
      expect(isEditorRequest(url)).toBe(true);
    });
    ...
    it("should handle parameters with special characters in values", () => {
      const url = new URL(
        "https://example.com/?_storyblok=abc%20def&_storyblok_c=456&_storyblok_tk[space_id]=789",
      );
      expect(isEditorRequest(url)).toBe(true);
    });
    ...
    it("should handle empty parameter values", () => {
      const url = new URL(
        "https://example.com/?_storyblok=&_storyblok_c=&_storyblok_tk[space_id]=789",
      );
      expect(isEditorRequest(url)).toBe(true);
    });
  });
  ...
  describe("parameter order independence", () => {
    it("should work regardless of parameter order", () => {
      ...
      const url2 = new URL(
        "https://example.com/?_storyblok_tk[space_id]=789&_storyblok_c=456&_storyblok=123",
      );
      const url3 = new URL(
        "https://example.com/?_storyblok_c=456&_storyblok_tk[space_id]=789&_storyblok=123",
      );
  ...
  describe("real-world scenarios", () => {
    it("should validate a typical Storyblok editor preview URL", () => {
      const url = new URL(
        "https://my-site.com/blog/article-1?_storyblok=12345678&_storyblok_c=blog&_storyblok_tk[space_id]=98765&_storyblok_tk[timestamp]=1234567890",
      );
      expect(isEditorRequest(url)).toBe(true);
    });
    ...
    it("should validate editor request with correct space ID and reject with wrong one", () => {
      const url = new URL(
        "https://my-site.com/?_storyblok=123&_storyblok_c=456&_storyblok_tk[space_id]=98765",
      );
