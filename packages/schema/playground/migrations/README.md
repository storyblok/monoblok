...
field translations, datasource options, tables — plus twenty-two migrations that each break it a
...
```sh
pnpm migrate:offline    # all twenty-two
pnpm test               # all twenty-two, plus the recorded expectations and the round trip
```
