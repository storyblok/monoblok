...
describe("sbFetch", () => {
  ...
  describe("post", () => {
    it("should handle POST requests correctly", async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith("https://api.storyblok.com/v2/stories", {
        method: "post",
  ...
  describe("put", () => {
    it("should handle PUT requests correctly", async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith("https://api.storyblok.com/v2/stories/1", {
        method: "put",
        body: JSON.stringify(testPayload),
        headers: expect.any(Headers),
        signal: expect.any(AbortSignal),
  ...
  describe("timeout behavior", () => {
    ...
    it("should return clear error message for timeout", async () => {
      ...
      expect((result as any).message).toBe(
        "Request timeout: The request was aborted due to timeout",
      );
    });
  });
});
