...
export function createAssetFoldersResource<DefaultThrowOnError extends boolean = false>(
  ...
  return {
    list<ThrowOnError extends boolean = DefaultThrowOnError>(
      options: {
        query?: ListAssetFoldersData["query"];
        signal?: AbortSignal;
        throwOnError?: ThrowOnError;
        fetchOptions?: FetchOptions;
      } & SpaceIdPathOverride = {},
    ): Promise<ApiResponse<ListAssetFoldersResponses[200], ThrowOnError>> {
      const { query, signal, path, throwOnError, fetchOptions } = options;
      const resolvedSpaceId = getSpaceId(path);
      return wrapRequest<ListAssetFoldersResponses[200], ThrowOnError>(
        () =>
          mapi.listAssetFolders({
            client,
    ...
    ): Promise<ApiResponse<GetAssetFolderResponses[200], ThrowOnError>> {
    ...
    create<ThrowOnError extends boolean = DefaultThrowOnError>(
      options: {
        body: CreateAssetFolderData["body"];
        signal?: AbortSignal;
        throwOnError?: ThrowOnError;
        fetchOptions?: FetchOptions;
      } & SpaceIdPathOverride,
    ): Promise<ApiResponse<CreateAssetFolderResponses[201], ThrowOnError>> {
      const { body, signal, path, throwOnError, fetchOptions } = options;
      const resolvedSpaceId = getSpaceId(path);
      return wrapRequest<CreateAssetFolderResponses[201], ThrowOnError>(
        () =>
          mapi.createAssetFolder({
            client,
            path: { space_id: resolvedSpaceId },
            body,
            signal,
    ...
    update<ThrowOnError extends boolean = DefaultThrowOnError>(
      assetFolderId: number,
      options: {
        body: UpdateAssetFolderData["body"];
        signal?: AbortSignal;
        throwOnError?: ThrowOnError;
        fetchOptions?: FetchOptions;
      } & SpaceIdPathOverride,
    ...
    delete<ThrowOnError extends boolean = DefaultThrowOnError>(
      assetFolderId: number,
      options: {
        query?: DeleteAssetFolderData["query"];
        signal?: AbortSignal;
        throwOnError?: ThrowOnError;
        fetchOptions?: FetchOptions;
      } & SpaceIdPathOverride = {},
