...
const FIXTURES_DIR = new URL("__test__/fixtures/.storyblok/components/12345", import.meta.url)
  .pathname;
...
describe("getLocalComponents", () => {
  ...
  it("should return empty array for empty directory", async () => {
    const emptyDir = new URL("__test__/fixtures/empty-components-dir", import.meta.url).pathname;
...
describe("updateLocalComponent", () => {
  const TEST_DIR = new URL("__test__/fixtures/test-write-components", import.meta.url).pathname;
