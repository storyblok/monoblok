...
field translations, datasource options, tables — plus twenty-three migrations that each break it a
...
```sh
pnpm migrate:offline    # all twenty-three
pnpm test               # all twenty-three, plus the recorded expectations and the round trip
```
