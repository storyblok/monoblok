...
const TYPE_ALIAS_NAMES = new Set([
  ...
  'Component', // was: type Component = component
  'ComponentCreate', // was: type ComponentCreate = component_create
  'ComponentUpdate', // was: type ComponentUpdate = component_update
  'DatasourceCreate', // was: type DatasourceCreate = datasource_create
  'DatasourceUpdate', // was: type DatasourceUpdate = datasource_update
]);
...
async function main() {
  ...
  // -------------------------------------------------------------------------
  // Add missing types (unreferenced schemas that openapi-zod-client skips)
  // -------------------------------------------------------------------------
  for (const typeName of ['Asset', 'Datasource'] as const) {
