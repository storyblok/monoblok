...
describe("getLocalDatasources", () => {
  ...
  it("should return empty array for empty directory", async () => {
    const emptyDir = new URL("__test__/fixtures/empty-datasources-dir", import.meta.url).pathname;
...
describe("updateLocalDatasource", () => {
  const TEST_DIR = new URL("__test__/fixtures/test-write-datasources", import.meta.url).pathname;
