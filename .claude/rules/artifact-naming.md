...
When the same PR/issue produces multiple artifacts (summary + review), the identifier stays the same
and the type differentiates them: `pr-435-summary.md`, `review-pr-435.md`.
