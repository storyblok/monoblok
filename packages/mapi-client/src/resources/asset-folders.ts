...
export function createAssetFoldersResource(deps: MapiResourceDeps) {
  ...
  return {
    ...
    get<ThrowOnError extends boolean = false>(assetFolderId: number | string, options: { signal?: AbortSignal; throwOnError?: ThrowOnError; fetchOptions?: FetchOptions } & SpaceIdPathOverride = {}): Promise<ApiResponse<GetResponses[200], ThrowOnError>> {
