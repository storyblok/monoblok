...
import { DEFAULT_COMPONENT_TYPES_FILENAME, type GenerateTypesOptions } from "./constants";
...
export const saveTypesToComponentsFile = async (
  ...
  const { filename = DEFAULT_COMPONENT_TYPES_FILENAME, path, separateFiles } = options;
