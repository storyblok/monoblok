...
The long form behind [README.md](README.md) — what the seed space is shaped like, what the twenty
catalogue migrations each prove, how the design settled, and what it still does not cover.
