...
- **No redundancy**: specs describe _what_, outcome verifies _done_. Never have both say the same
  thing.
...
- Optional sections: **Open Questions** (at top), **Use Cases**, **Risks**, **Notes**,
  **Milestones**, **Reference**, **Out of scope**
- DX specs (command syntax, config formats, file structures) ARE specifications
- SDK projects: bold labels inline (**Features**, **Environments**, **Compatibility**, **Testing**,
  **DX**)
