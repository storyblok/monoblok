...
describe("validateSpaceId", () => {
  ...
  it("should handle BigInt space IDs as strings correctly", () => {
    expect(validateSpaceId(bigIntSpaceIds.eu.toString())).toBe(bigIntSpaceIds.eu);
    expect(validateSpaceId(bigIntSpaceIds.us.toString())).toBe(bigIntSpaceIds.us);
    expect(validateSpaceId(bigIntSpaceIds.ca.toString())).toBe(bigIntSpaceIds.ca);
    expect(validateSpaceId(bigIntSpaceIds.ap.toString())).toBe(bigIntSpaceIds.ap);
    expect(validateSpaceId(bigIntSpaceIds.cn.toString())).toBe(bigIntSpaceIds.cn);
  });
});
