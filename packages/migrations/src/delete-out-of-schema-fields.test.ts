...
describe("deleteOutOfSchemaFields", () => {
  it("should keep system fields _uid, component, _editable even if not in schema", () => {
    ...
    const { story: result } = deleteOutOfSchemaFields(story as any, schemaDefinition);
  ...
  it("should work recursively with nested bloks", () => {
    ...
    const { story: result } = deleteOutOfSchemaFields(story as any, schemaWithBody);
  ...
  it("should return list of removed fields", () => {
    ...
    const { removedFields } = deleteOutOfSchemaFields(story as any, schemaDefinition);
