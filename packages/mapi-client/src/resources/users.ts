...
export function createUsersResource<DefaultThrowOnError extends boolean = false>(
  ...
  return {
    me<ThrowOnError extends boolean = DefaultThrowOnError>(
      options: {
        signal?: AbortSignal;
        throwOnError?: ThrowOnError;
        fetchOptions?: FetchOptions;
      } = {},
    ): Promise<ApiResponse<GetCurrentUserResponses[200], ThrowOnError>> {
    ...
    updateMe<ThrowOnError extends boolean = DefaultThrowOnError>(options: {
      body: UpdateCurrentUserData["body"];
      signal?: AbortSignal;
      throwOnError?: ThrowOnError;
      fetchOptions?: FetchOptions;
    }): Promise<ApiResponse<UpdateCurrentUserResponses[200], ThrowOnError>> {
      const { body, signal, throwOnError, fetchOptions } = options;
      return wrapRequest<UpdateCurrentUserResponses[200], ThrowOnError>(
        () =>
          mapi.updateCurrentUser({
            client,
            body,
            signal,
            ...(throwOnError === undefined ? {} : { throwOnError }),
