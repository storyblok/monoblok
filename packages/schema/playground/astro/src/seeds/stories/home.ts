          ...
          items: [
            {
              ...
              description:
                "Define reusable fields and components in TypeScript. Types flow from schema to fetch calls.",
              image: null,
              link: null,
            },
            {
              ...
              description:
                "Push components and stories to Storyblok programmatically using @storyblok/management-api-client.",
              image: null,
              link: null,
            },
            {
              ...
              description:
                "Fetch stories with a typed client that understands your schema's discriminated unions.",
              image: null,
              link: null,
            },
          ],
