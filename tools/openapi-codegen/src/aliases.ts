...
export const ALIASES = [
  ...
  {
    source: "ComponentCreateRequest",
    spec: "mapi",
    emitAs: "ComponentCreate",
    unwrap: "component",
  },
  {
    source: "ComponentUpdateRequest",
    spec: "mapi",
    emitAs: "ComponentUpdate",
    unwrap: "component",
  },
  ...
  {
    source: "CreateAssetFolderData",
    spec: "mapi",
    emitAs: "AssetFolderCreate",
    unwrap: "body.asset_folder",
  },
  {
    source: "UpdateAssetFolderData",
    spec: "mapi",
    emitAs: "AssetFolderUpdate",
    unwrap: "body.asset_folder",
  },
  { source: "ComponentGroup", spec: "mapi", emitAs: "ComponentFolder" },
  {
    source: "ComponentGroupRequest",
    spec: "mapi",
    emitAs: "ComponentFolderCreate",
    unwrap: "component_group",
  },
  {
    source: "ComponentGroupRequest",
    spec: "mapi",
    emitAs: "ComponentFolderUpdate",
    unwrap: "component_group",
  },
  ...
  { source: "Datasource", spec: "mapi", emitAs: "MapiDatasource" },
  {
    ...
    spec: "mapi",
    emitAs: "DatasourceCreate",
    unwrap: "datasource",
  },
  {
    source: "UpdateDatasourceRequest",
    spec: "mapi",
    emitAs: "DatasourceUpdate",
    unwrap: "datasource",
  },
  {
    source: "CreateDatasourceEntryRequest",
    spec: "mapi",
    emitAs: "DatasourceEntryCreate",
    unwrap: "datasource_entry",
  },
  {
    source: "UpdateDatasourceEntryRequest",
    spec: "mapi",
    emitAs: "DatasourceEntryUpdate",
    unwrap: "datasource_entry",
  },
  { source: "InternalTag", spec: "mapi", emitAs: "InternalTag" },
  {
    source: "InternalTagRequest",
    spec: "mapi",
    emitAs: "InternalTagCreate",
    unwrap: "internal_tag",
  },
  {
    source: "InternalTagRequest",
    spec: "mapi",
    emitAs: "InternalTagUpdate",
    unwrap: "internal_tag",
  },
  ...
  {
    source: "CreateSpaceSharedAssetFolderData",
    spec: "mapi",
    emitAs: "SharedAssetFolderCreate",
    unwrap: "body.shared_asset_folder",
  },
  {
    source: "UpdateSpaceSharedAssetFolderData",
    spec: "mapi",
    emitAs: "SharedAssetFolderUpdate",
    unwrap: "body.shared_asset_folder",
  },
  {
    source: "SharedInternalTagRequest",
    spec: "mapi",
    emitAs: "SharedInternalTagCreate",
    unwrap: "shared_internal_tag",
  },
