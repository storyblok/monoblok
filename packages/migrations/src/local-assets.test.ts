...
const FIXTURES_DIR = new URL("__test__/fixtures/.storyblok/assets/12345", import.meta.url).pathname;
...
describe("getLocalAssets", () => {
  ...
  it("should return empty array for empty directory", async () => {
    const emptyDir = new URL("__test__/fixtures/empty-assets-dir", import.meta.url).pathname;
...
describe("updateLocalAsset", () => {
  const TEST_DIR = new URL("__test__/fixtures/test-write-assets", import.meta.url).pathname;
