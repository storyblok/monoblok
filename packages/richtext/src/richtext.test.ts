...
describe('richtext', () => {
  ...
  describe('blocktypes', () => {
    ...
    it('should render an emoji', async () => {
      ...
      expect(html).toBe('<img src="https://cdn.jsdelivr.net/npm/emoji-datasource-apple/img/apple/64/1f60b.png" style="width: 1.25em; height: 1.25em; vertical-align: text-top" draggable="false" loading="lazy" emoji="🚀" name="smile">');
    });
  ...
  describe('textTypes & MarksTypes', () => {
    ...
    it('should render an emoji with keys', async () => {
      ...
      const html = render(emoji as unknown as StoryblokRichTextNode<string>);
      expect(html).toBe('<img src="smile.png" style="width: 1.25em; height: 1.25em; vertical-align: text-top" draggable="false" loading="lazy" emoji="😊" name="smile" key="img-0">');
    });
