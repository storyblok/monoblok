...
describe("@storyblok/react", () => {
  ...
  describe("getStoryblokApi", () => {
    ...
    it("should return an error message when no access token is provided", () => {
      mount(<Test />);
      cy.get("@error").should("be.calledWithMatch", "You can't use getStoryblokApi");
    });
  });
  ...
  describe("storyblokComponent", () => {
    it("should render the StoryblokComponent if the blok is passed", () => {
      ...
      mount(<Test blok={blok} accessToken="OurklwV5XsDJTIE1NJaD2wtt" components={components} />);
    ...
    it("should log an error if the blok is not loaded", () => {
      ...
      mount(<Test accessToken="OurklwV5XsDJTIE1NJaD2wtt" components={components} />);
    ...
    it("should log an error if the component is not loaded", () => {
      ...
      cy.get("@error").should("be.calledWithMatch", "Component teaser doesn't exist.");
    });
  ...
  describe("fallbackComponent", () => {
    it("should render the default Fallback Component", () => {
      ...
      mount(<Test blok={blok} components={[]} enableFallbackComponent={true} />);
  ...
  describe("useStoryblok", () => {
    it("should render the StoryblokComponent", () => {
      ...
      mount(<TestUseStoryblok accessToken="OurklwV5XsDJTIE1NJaD2wtt" components={components} />);
