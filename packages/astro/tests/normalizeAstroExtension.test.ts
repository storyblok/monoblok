...
describe("normalizeAstroExtension", () => {
  ...
  it("should work with nested paths", () => {
    expect(normalizeAstroExtension("components/Button")).toBe("components/Button.astro");
  });

  it("should not double append .astro", () => {
    expect(normalizeAstroExtension("components/Card.astro")).toBe("components/Card.astro");
  });
