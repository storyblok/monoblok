...
> = Component extends TComponents ? MapiStory : MapiStory<TComponents, TFieldPlugins>;

type GetResponse<TComponents extends Component, TFieldPlugins = Record<never, never>> = Omit<
  GetStoryByIdResponses[200],
  "story"
> & { story?: StoryResult<TComponents, TFieldPlugins> };

type ListResponse<TComponents extends Component, TFieldPlugins = Record<never, never>> = Omit<
  ListStoriesResponses[200],
  "stories"
> & { stories?: Array<StoryResult<TComponents, TFieldPlugins>> };

type CreateResponse<TComponents extends Component, TFieldPlugins = Record<never, never>> = Omit<
  CreateStoryResponses[201],
  "story"
> & { story?: StoryResult<TComponents, TFieldPlugins> };

type UpdateResponse<TComponents extends Component, TFieldPlugins = Record<never, never>> = Omit<
  UpdateStoryResponses[200],
  "story"
> & { story?: StoryResult<TComponents, TFieldPlugins> };

type DuplicateResponse<TComponents extends Component, TFieldPlugins = Record<never, never>> = Omit<
  DuplicateStoryResponses[200],
  "story"
> & { story?: StoryResult<TComponents, TFieldPlugins> };

type PublishResponse<TComponents extends Component, TFieldPlugins = Record<never, never>> = Omit<
  PublishStoryResponses[200],
  "story"
> & { story?: StoryResult<TComponents, TFieldPlugins> };
...
>(deps: MapiResourceDeps<DefaultThrowOnError>) {
  ...
  return {
    ...
    ): Promise<ApiResponse<ListResponse<TComponents, TFieldPlugins>, ThrowOnError>> {
    ...
    get<ThrowOnError extends boolean = DefaultThrowOnError>(
      storyId: number,
      options: {
        query?: GetStoryByIdData["query"];
        signal?: AbortSignal;
        throwOnError?: ThrowOnError;
        fetchOptions?: FetchOptions;
      } & SpaceIdPathOverride = {},
    ): Promise<ApiResponse<GetResponse<TComponents, TFieldPlugins>, ThrowOnError>> {
      const { query, signal, path, throwOnError, fetchOptions } = options;
      const resolvedSpaceId = getSpaceId(path);
    ...
    create<ThrowOnError extends boolean = DefaultThrowOnError>(
      options: {
        body: CreateBody<TComponents, TFieldPlugins>;
        query?: CreateStoryData["query"];
        signal?: AbortSignal;
        throwOnError?: ThrowOnError;
        fetchOptions?: FetchOptions;
      } & SpaceIdPathOverride,
    ): Promise<ApiResponse<CreateResponse<TComponents, TFieldPlugins>, ThrowOnError>> {
    ...
    update<ThrowOnError extends boolean = DefaultThrowOnError>(
      storyId: number,
      options: {
        body: UpdateBody<TComponents, TFieldPlugins>;
        query?: UpdateStoryData["query"];
        signal?: AbortSignal;
        throwOnError?: ThrowOnError;
        fetchOptions?: FetchOptions;
      } & SpaceIdPathOverride,
    ...
    ): Promise<ApiResponse<DeleteStoryResponses[200], ThrowOnError>> {
    ...
    duplicate<ThrowOnError extends boolean = DefaultThrowOnError>(
      storyId: number,
      options: {
        body: DuplicateStoryData["body"];
        query?: DuplicateStoryData["query"];
        signal?: AbortSignal;
        throwOnError?: ThrowOnError;
        fetchOptions?: FetchOptions;
      } & SpaceIdPathOverride,
